...
generare oggetti vedi Sez 5.1.

Per quello che ci riguarda in questa fase le usiamo come funzioni.
Infatti si comportano esattamente come funzioni che restituiscono un valore.
...
"""La funzione len() ci restituisce la lunghezza di un elemento che gli 
viene passato
Se si tratta di una stringa, restituisce il numero di caratteri, se è una 
lista restituisce il numero di elementi.."""
help(len)
